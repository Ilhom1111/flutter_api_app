...
import '../services/netvorc_service.dart';
...
class _UserListPageState extends State<UserListPage> {
  ...
  void getAllUser() async {
    ...
    final response = await Network.methodGet(
        api: Network.users, baseUrl: Network.baseUrlUsers);
  ...
  void userDelete(String id) async {
    ...
    await Network.methodDelete(
        api: Network.users, baseUrl: Network.baseUrlUsers, id: id);
    getAllUser();
  }
  ...
  void createUser() async {
    ...
    final msg = await Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => const UserDetailPage()));
    setState(() => isLoading = false);
